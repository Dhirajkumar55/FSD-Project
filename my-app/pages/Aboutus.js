    ...
    <div className={styles.bg_white} style={{paddingTop: "3rem",paddingBottom: "3rem"}}>
        <div className={styles.container} style={{paddingTop: "3rem",paddingBottom: "3rem"}}>
            <div className={styles.row} style={{marginBottom: "3rem"}}>
                ...
                <div className={styles.col_lg_5}  style={{paddingRight: "3rem" ,paddingLeft: "3rem",order: "1",order: "2",marginLeft:"200px"}}><img src="https://bootstrapious.com/i/snippets/sn-about/img-1.jpg" alt="" className="img-fluid" style={{marginBottom: "0",maxWidth: "100%",height: "auto"}}/></div>
            </div>
        </div>
    </div>
        ...
        <div className={styles.container} style={{paddingTop: "3rem",paddingBottom: "3rem"}}>
            ...
            <div className={styles.row} style={{textAlign: "center", display: "flex",justifyContent: "space-around"}}>
                <div className={styles.col_xl_3} style={{marginBottom: "3rem"}}>
                    <div className={styles.devlop} style={{paddingTop: "3rem",paddingBottom: "3rem", borderRadius: ".25rem"}}><img src="https://bootstrapious.com/i/snippets/sn-about/avatar-2.png" alt="" width="100" className={styles.img_thumbnail} />
                ...
                <div className={styles.col_xl_3} style={{marginBottom: "3rem"}}>
                    <div className={styles.devlop} style={{paddingTop: "3rem",paddingBottom: "3rem",borderRadius: ".25rem"}}><img src="https://bootstrapious.com/i/snippets/sn-about/avatar-3.png" alt="" width="100" className={styles.img_thumbnail} />
                ...
                <div className={styles.col_xl_3} style={{marginBottom: "3rem"}}>
                    <div className={styles.devlop} style={{paddingTop: "3rem",paddingBottom: "3rem",borderRadius: ".25rem"}}><img src="https://bootstrapious.com/i/snippets/sn-about/avatar-1.png" alt="" width="100" className={styles.img_thumbnail} />
